...
open class LocalStorage(private val context: Context) {
    //  Member Variables
    private var mName: String = "in.hexcommand.asktoagri"
    private var sharedPref: SharedPreferences =
        context.getSharedPreferences(this.mName, Context.MODE_PRIVATE)
